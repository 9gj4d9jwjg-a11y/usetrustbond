...
const TransparencySection = ({ className = '' }: TransparencySectionProps) => {
    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 lg:px-[6vw]">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
          <div
            ref={leftCardRef}
            className="card-enkoji w-full lg:w-[40%] p-8 lg:p-12 flex flex-col justify-center"
          >
            ...
            <h2 className="text-3xl lg:text-4xl font-serif text-[#1F1F1F] leading-tight mb-8">
              Seu dinheiro só se move quando a terra se move.
            </h2>
            <p className="text-[#6E6E6E] leading-relaxed text-lg">
              Cada fase só é liberada após evidências claras: fotos, notas fiscais e um breve relatório técnico de execução.
            </p>
          </div>

          <div
            ref={rightCardRef}
            className="card-enkoji w-full lg:w-[60%] p-8 lg:p-12 relative"
          >
            {/* Timeline Line */}
            <div
              ref={lineRef}
              className="absolute left-[3rem] lg:left-[4rem] top-12 bottom-12 w-[2px] bg-[rgba(31,31,31,0.1)]"
            />
