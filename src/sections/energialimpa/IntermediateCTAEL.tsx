...
const IntermediateCTAEL = () => {
  ...
  return (
    <div ref={sectionRef} className="bg-[#4A5D23] py-16 lg:py-20 relative overflow-hidden">
      <div
      ...
      <div className="max-w-3xl mx-auto px-6 text-center relative z-10">
        ...
        <p className="text-2xl sm:text-3xl lg:text-4xl font-serif text-white leading-relaxed mb-8">
          Você já imaginou um espaço seco, confortável e alimentado pelo sol — onde crianças aprendem, comunidades se encontram e a prática floresce?
        </p>

        <p className="text-white/70 text-lg mb-10 max-w-xl mx-auto">
          Cada contribuição, por menor que seja, se transforma em telhas que protegem e cabos que conduzem energia limpa.
        </p>
...
export default IntermediateCTAEL;
