...
export default function FooterTech({ className = '' }: { className?: string }) {
  ...
  return (
    <footer ref={sectionRef} className={`relative bg-[#0A1F0A] overflow-hidden ${className}`}>
      <div ref={ctaRef} className="relative z-10 py-24 lg:py-32">
        <div className="max-w-4xl mx-auto px-6 sm:px-8 text-center">
          <h2 className="anim text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6">
            Tecnologia que <span className="text-[#4ADE80]">transforma</span>
          </h2>
          <p className="anim text-xl text-white/70 mb-10 max-w-2xl mx-auto">
            Blockchain, gamificação e rastreabilidade a serviço da economia circular e do impacto real.
          </p>
      ...
      <div className="relative z-10 border-t border-white/10 py-8 px-6">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <span className="text-xs text-white/40">© 2026 Trustbond • Tech-Rastreabilidade • VivaTerra</span>
        </div>
      </div>
    </footer>
  );
