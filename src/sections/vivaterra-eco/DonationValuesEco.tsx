...
const tiers = [
  { label: 'BÁSICO', value: 'R$ 100', features: ['Logística de coleta de 50 litros', 'Acesso ao dashboard mensal', 'Certificado digital de impacto'], highlight: false, badge: null },
  { label: 'IMPACTO MÉDIO', value: 'R$ 500', features: ['Processamento de 200 kg de óleo', 'Nome no mural de doadores', 'Convite para visita à planta', 'Relatório personalizado'], highlight: true, badge: 'Mais Popular' },
  { label: 'TRANSFORMADOR', value: 'R$ 1.000', features: ['Infraestrutura completa para expansão', 'Reunião anual com diretoria', 'Reconhecimento público', 'Prioridade em novos projetos'], highlight: false, badge: null },
];

export default function DonationValuesEco({ className = '' }: { className?: string }) {
  ...
  return (
    <section id="doar" ref={sectionRef} className={`relative py-24 lg:py-32 bg-[#0A1F0A] overflow-hidden ${className}`}>
      <div className="max-w-6xl mx-auto px-6 sm:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-white/60 text-lg max-w-2xl mx-auto">Sua contribuição é multiplicada por 5× graças aos investidores institucionais via Smart Vaults da Trustbond</p>
        </div>
